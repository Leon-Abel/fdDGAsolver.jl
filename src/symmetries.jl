...
function sΣ(
    ...
    return (-w[1],), Operation{ComplexF64}(sgn = true, con = true)
end
...
function sK2pp2(
    ...
    return (w[1], w[1] - w[2]), Operation{ComplexF64}()
end
...
function sK3pp1(
    ...
    return (-w[1], -w[2], -w[3]), Operation{ComplexF64}(sgn = false, con = true)
end
...
function sK3pp2(
    ...
    return (w[1], w[3], w[2]), Operation{ComplexF64}()
end
...
function sK3pp3(
    ...
    return (w[1], w[1] - w[2], w[1] - w[3]), Operation{ComplexF64}()
end
